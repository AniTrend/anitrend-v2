...
package co.anitrend.data.thexem.api
...
import co.anitrend.data.thexem.BuildConfig
...
internal class TheXemApiFactory : IEndpointFactory {
    override val endpointType = object : IEndpointType {
        override val url: HttpUrl = BuildConfig.theXemApi.toHttpUrl()
    }
