 ...
 */
package co.anitrend.android.navigation.drawer.controller.model.account
...
import co.anitrend.android.navigation.drawer.databinding.AccountAnonymousItemBinding
...
class AuthorizeAccountItem(
    ...
    override fun bind(
        ...
        disposable =
            requireBinding().accountProfileImage.load(
    ...
    companion object {
        internal fun LayoutInflater.createAuthorizeAccountViewHolder(viewGroup: ViewGroup) =
            AccountAnonymousItemBinding
                .inflate(
                    this,
                    viewGroup,
                    false,
