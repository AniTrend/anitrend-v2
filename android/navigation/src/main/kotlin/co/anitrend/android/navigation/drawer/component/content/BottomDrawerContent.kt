...
import co.anitrend.android.core.animations.lerp
...
import co.anitrend.android.core.extensions.applySystemBarsWindowInsetsListener
import co.anitrend.core.component.content.AniTrendContent
import co.anitrend.core.ui.inject
import co.anitrend.android.navigation.drawer.R
import co.anitrend.android.navigation.drawer.action.OnSandwichSlideAction
...
) : AniTrendContent<BottomNavigationDrawerBinding>(),
    INavigationDrawer {
                ...
                duration =
                    (
                        abs(newProgress - initialProgress) *
                            resources.getInteger(co.anitrend.android.core.R.integer.motion_duration_medium)
                    ).toLong()
            }
