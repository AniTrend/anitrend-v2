...
import co.anitrend.android.navigation.drawer.databinding.NavigationMenuItemBinding
...
class MenuNavigationItem(
    ...
    companion object {
        internal fun LayoutInflater.createNavMenuViewHolder(viewGroup: ViewGroup) =
            NavigationMenuItemBinding
                .inflate(
                    this,
                    viewGroup,
                    false,
