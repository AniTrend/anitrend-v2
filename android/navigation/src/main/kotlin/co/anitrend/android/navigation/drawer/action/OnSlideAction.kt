 ...
 */
package co.anitrend.android.navigation.drawer.action
...
class ForegroundSheetTransformSlideAction(
    ...
    private fun getPaddingTop(): Int {
        ...
        // changes.
        if (systemTopInset == 0) {
            systemTopInset = foregroundView.getTag(co.anitrend.android.core.R.id.tag_system_window_inset_top) as? Int? ?: 0
        }
