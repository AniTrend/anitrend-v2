...
class OnBoardingPresenter(
    ...
    val onBoardingPages =
        listOf(
            ...
            OnboardingPage(
                resource = co.anitrend.android.deeplink.R.drawable.search,
                background = listOf(Color(0xFFE8EAF6), Color(0xFF7986CB)),
                title = co.anitrend.android.deeplink.R.string.onboarding_title_search,
                description = co.anitrend.android.deeplink.R.string.onboarding_desc_search,
            ),
            OnboardingPage(
                resource = co.anitrend.android.deeplink.R.drawable.rating,
                background = listOf(Color(0xFFEFEBE9), Color(0xFFA1887F)),
                title = co.anitrend.android.deeplink.R.string.onboarding_title_rating,
                description = co.anitrend.android.deeplink.R.string.onboarding_desc_rating,
            ),
            OnboardingPage(
                resource = co.anitrend.android.deeplink.R.drawable.smart,
                background = listOf(Color(0xFFECEFF1), Color(0xFF607D8B)),
                title = co.anitrend.android.deeplink.R.string.onboarding_title_smart,
                description = co.anitrend.android.deeplink.R.string.onboarding_desc_smart,
            ),
            OnboardingPage(
                resource = co.anitrend.android.deeplink.R.drawable.adventure,
                background = listOf(Color(0xFFFBE9E7), Color(0xFFFF8A65)),
                title = co.anitrend.android.deeplink.R.string.onboarding_title_adventure,
                description = co.anitrend.android.deeplink.R.string.onboarding_desc_adventure,
            ),
        )
