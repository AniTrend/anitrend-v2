 ...
 */
package co.anitrend.android.core.animations
...
fun lerp(
    ...
    endValue: Int,
    @FloatRange(from = 0.0, fromInclusive = true, to = 1.0, toInclusive = true) fraction: Float,
): Int = (startValue + fraction * (endValue - startValue)).roundToInt()
...
fun Float.normalize(
    ...
    return outputMin *
        (1 - (this - inputMin) / (inputMax - inputMin)) +
        outputMax *
        ((this - inputMin) / (inputMax - inputMin))
}
