 ...
 */
package co.anitrend.android.core.components.sheet

import android.view.View
import androidx.coordinatorlayout.widget.CoordinatorLayout
import co.anitrend.android.core.R
import co.anitrend.android.core.animations.normalize
 ...
 */
class SheetBehaviourCallback : BottomSheetBehavior.BottomSheetCallback() {
    ...
    fun addOnSlideAction(action: OnSlideAction): Boolean = onSlideActions.add(action)

    fun removeOnSlideAction(action: OnSlideAction): Boolean = onSlideActions.remove(action)

    fun addOnStateChangedAction(action: OnStateChangedAction): Boolean = onStateChangedActions.add(action)

    fun removeOnStateChangedAction(action: OnStateChangedAction): Boolean = onStateChangedActions.remove(action)
}
