...
object HctSolver {
    val SCALED_DISCOUNT_FROM_LINRGB =
        arrayOf(
            doubleArrayOf(
    ...
    val LINRGB_FROM_SCALED_DISCOUNT =
        arrayOf(
            doubleArrayOf(
                1373.2198709594231,
                -1100.4251190754821,
     ...
     */
    fun sanitizeRadians(angle: Double): Double = (angle + kotlin.math.PI * 8) % (kotlin.math.PI * 2)
    ...
    fun intercept(
        ...
        mid: Double,
        target: Double,
    ): Double = (mid - source) / (target - source)
    ...
    fun solveToCam(
        ...
        chroma: Double,
        lstar: Double,
    ): Cam16 = Cam16.Companion.fromInt(solveToInt(hueDegrees, chroma, lstar))
}
