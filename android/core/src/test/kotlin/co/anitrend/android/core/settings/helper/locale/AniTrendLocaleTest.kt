 ...
 */
package co.anitrend.android.settings.helper.locale
...
class AniTrendLocaleTest {
    @Test
    fun `verify correct convention on locale extension`() {
        val given = AniTrendLocale.FRENCH_FRANCE
        val expected = "frFR"

        val actual = given.asLocaleString()
