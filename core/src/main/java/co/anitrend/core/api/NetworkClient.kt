...
import io.wax911.support.core.wrapper.extension.isRateLimitReached
import io.wax911.support.core.wrapper.extension.isRequestFailure
...
class NetworkClient: SupportRequestClient() {
     ...
     */
    override fun <T> executeUsing(call: Call<T>): RetroWrapper<T?> {
        try {
            callList.add(call)
