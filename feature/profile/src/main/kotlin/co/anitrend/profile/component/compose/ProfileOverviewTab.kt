...
@Composable
private fun ProfileLibraryPulseSection(
    summary: ProfileLibraryPulseSummary,
) {
    val metricItems =
        listOf(
            ...
            stringResource(R.string.label_profile_metric_collection_bias) to summary.dominantStatus.ifBlank {
