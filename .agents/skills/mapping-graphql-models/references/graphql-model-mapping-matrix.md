...
Use this matrix to map contract changes from schema and generated operation files to Kotlin model
and source wiring.
...
| Fragment shape | `data/src/main/graphql/fragments/**` | `data/edge/src/main/graphql/fragments/**` | `data/*/model/**` variant classes | Fragment granularity should mirror variant responsibility. |
| Query composition | `data/src/main/graphql/queries/**` | `data/edge/src/main/graphql/queries/**` | `data/*/datasource/remote/*RemoteSource.kt` | Generated request types should align with operation names. |
| Mutation composition | `data/src/main/graphql/mutations/**` | `data/edge/src/main/graphql/mutations/**` | mutation response model container types | Keep post-write state needs explicit. |
...
| Source orchestration | `data/src/main/kotlin/**/source/**` | `data/edge/src/main/kotlin/**/source/**` | source contract variants | Source selects operation and variant fit. |

## Concrete Media Mapping

### Fragment family

- `data/src/main/graphql/fragments/media/Media.graphql`
- `data/src/main/graphql/fragments/media/MediaCore.graphql`
- `data/src/main/graphql/fragments/media/MediaExtended.graphql`
...
|---|---|---|
| New read-only AniList field on media detail | `fragments/media/*.graphql` | Update model variant plus container, generated request use site, remote response typing, and source path |
| New edge-only media enrichment field | edge fragments plus edge query operation | Update edge model plus edge local or source flow and enrich converter |
| New mutation post-write field | mutation selection set plus reusable fragment if possible | Update mutation container plus mapper or local updates |
