...
package co.anitrend.data.character.entity.fts
...
@Entity(tableName = "character_fts")
@Fts4(contentEntity = CharacterEntity::class)
internal data class CharacterFtsEntity(
