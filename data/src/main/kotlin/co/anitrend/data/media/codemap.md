...
Implements media detail, search paging, people, studios, stats, relations, and recommendations data access.

## Design Patterns

Uses the full offline-first and paging package shape with cache identities for each media resource variant.
