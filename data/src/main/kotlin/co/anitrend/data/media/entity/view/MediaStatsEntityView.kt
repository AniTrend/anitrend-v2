...
internal data class MediaStatsEntityView(
    @Embedded
    ...
    val scoreDistribution: List<MediaScoreDistributionEntity> = emptyList(),
    @Relation(
        parentColumn = "media_id",
        entityColumn = "media_id",
    )
    val statusDistribution: List<MediaStatusDistributionEntity> = emptyList(),
)
