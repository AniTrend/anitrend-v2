# data/src/main/kotlin/co/anitrend/data/status/

## Responsibility

Stores and maps media status distribution or status-related embedded data.

## Design Patterns

Provides converters, datasource, entity, mapper, model, Koin, and type alias support.
