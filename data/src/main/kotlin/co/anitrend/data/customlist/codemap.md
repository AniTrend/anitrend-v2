# data/src/main/kotlin/co/anitrend/data/customlist/

## Responsibility

Persists custom media list metadata used by media list and user settings flows.

## Design Patterns

Uses datasource, entity, mapper, and Koin packages as an embedded local-data component.
