# data/src/main/kotlin/co/anitrend/data/core/

## Responsibility

Contains core API endpoint contracts and data extensions used by AniList remote sources.

## Design Patterns

Keeps GraphQL endpoint factory and common extensions close to the main AniList package.
