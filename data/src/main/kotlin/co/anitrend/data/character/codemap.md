# data/src/main/kotlin/co/anitrend/data/character/

## Responsibility

Implements character search data access and character persistence.

## Design Patterns

Uses the standard cache, datasource, entity, mapper, converter, model, repository, source, usecase, and Koin package shape.
