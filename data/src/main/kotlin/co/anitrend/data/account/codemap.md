# data/src/main/kotlin/co/anitrend/data/account/

## Responsibility

Implements account repository plumbing and account actions for domain account contracts.

## Design Patterns

Uses action, repository, usecase, and Koin packages rather than the full Room-backed source shape.
