# data/src/main/kotlin/co/anitrend/data/link/

## Responsibility

Stores and maps external link data embedded by media and related response models.

## Design Patterns

Provides converter, datasource, entity, mapper, model, and Koin packages as shared embedded data support.
