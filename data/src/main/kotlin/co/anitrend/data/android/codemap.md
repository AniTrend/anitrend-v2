# data/src/main/kotlin/co/anitrend/data/android/

## Responsibility

Contains Android-specific database, Koin, and network bridge packages for the main data module.

## Design Patterns

Keeps app-facing data Android wiring separate from shared `data/core/` infrastructure.
