# data/src/main/kotlin/co/anitrend/data/rank/

## Responsibility

Stores and maps media rank data embedded by media responses.

## Design Patterns

Provides converter, datasource, entity, mapper, model, and Koin packages as embedded media support.
