# data/src/main/kotlin/co/anitrend/data/recommendation/

## Responsibility

Stores and maps recommendation data and media recommendation connections.

## Design Patterns

Provides converter, datasource, entity, mapper, model, Koin, and type alias support used by media and recommendation flows.
