...
abstract class MediaTagSource : SupportCoreDataSource() {

    protected abstract val mapper: GraphQLMapper<MediaTagCollection, List<MediaTag>>
     ...
     */
    protected abstract val observable: ISourceObservable<List<MediaTag>, Nothing?>
}