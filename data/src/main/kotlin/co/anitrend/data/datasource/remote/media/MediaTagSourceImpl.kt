...
class MediaTagSourceImpl(
    ...
    override fun getMediaTags(queryContainerBuilder: QueryContainerBuilder): LiveData<List<MediaTag>> {
        ...
        val deferred = async {
            mediaEndPoint.getMediaTags(queryContainerBuilder)
        }
    ...
    override val observable =
        object : ISourceObservable<List<MediaTag>, Nothing?> {
            /**
            ...
            override fun invoke(parameter: Nothing?): LiveData<List<MediaTag>> {
                return mediaTagDao.findAllLiveData()
            }
        }
