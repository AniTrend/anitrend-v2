...
package co.anitrend.data.model.response.core.thread.contract

import co.anitrend.data.entity.contract.IEntity
import co.anitrend.data.model.response.core.media.contract.IMedia
import co.anitrend.data.model.response.core.thread.ThreadCategory
...
interface IThread : IEntity {
    val body: String?
    val categories: List<ThreadCategory>?
    val createdAt: Long
