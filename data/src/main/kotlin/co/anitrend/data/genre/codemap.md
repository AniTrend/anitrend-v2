# data/src/main/kotlin/co/anitrend/data/genre/

## Responsibility

Implements cached AniList genre list reads.

## Design Patterns

Uses cache, converters, datasources, entities, mapper, model, repository, source, usecase, and Koin packages.
