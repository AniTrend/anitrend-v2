# data/src/main/kotlin/co/anitrend/data/carousel/

## Responsibility

Implements media carousel data used by discovery or home surfaces.

## Design Patterns

Uses cache, datasource, mapper, model, repository, source, usecase, and Koin packages.
