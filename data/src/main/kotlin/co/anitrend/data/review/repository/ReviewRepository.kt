...
internal sealed class ReviewRepository {
    ...
    class Rate(
        ...
        ReviewRateRepository {
        override fun rate(param: ReviewParam.Rate) = source create source(param)
    }

    class Save(
        private val source: ReviewSource.Save,
    ) : ReviewRepository(),
        ReviewSaveRepository {
        override fun save(param: ReviewParam.Save) = source create source(param)
    }

    class Delete(
        private val source: ReviewSource.Delete,
    ) : ReviewRepository(),
        ReviewDeleteRepository {
        override fun delete(param: ReviewParam.Delete) = source create source(param)
    }
}
