...
internal interface UserRepository {
    class Identifier(
        ...
        override suspend fun getUser(param: UserParam.Identifier) = source create source(param)
    }
    ...
    class ToggleFollow(
        ...
        override suspend fun toggleFollow(param: UserParam.ToggleFollow) = source create source(param)
    }
    ...
    class Update(
        ...
        override suspend fun updateProfile(param: UserParam.Update) = source create source(param)
    }
}
