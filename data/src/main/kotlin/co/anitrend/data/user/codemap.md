# data/src/main/kotlin/co/anitrend/data/user/

## Responsibility

Implements user lookup, authenticated user, profile, search, statistics, overview, feed, follow toggle, and update operations.

## Design Patterns

Uses cache, converter, datasource, entity, mapper, model, repository, settings, source, usecase, and Koin packages.
