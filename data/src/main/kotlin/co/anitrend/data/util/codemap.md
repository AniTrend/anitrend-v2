# data/src/main/kotlin/co/anitrend/data/util/

## Responsibility

Contains utility helpers for GraphQL response or request handling.

## Design Patterns

Provides utility functions only and does not own a repository or persistence flow.
