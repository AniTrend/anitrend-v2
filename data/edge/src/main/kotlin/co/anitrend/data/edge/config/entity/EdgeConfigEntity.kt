...
data class EdgeConfigEntity(
    @Embedded(prefix = "settings_") val settings: EdgeConfigSettingsEntity,
    @Embedded(prefix = "image_") val image: EdgeConfigImageEntity,
