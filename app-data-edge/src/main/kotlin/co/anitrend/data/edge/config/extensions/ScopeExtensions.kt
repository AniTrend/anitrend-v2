...
internal fun Scope.configStore() = get<IEdgeConfigStore>()

internal fun Scope.navigationStore() = get<IEdgeNavigationStore>()

internal fun Scope.genreStore() = get<IEdgeGenreStore>()
