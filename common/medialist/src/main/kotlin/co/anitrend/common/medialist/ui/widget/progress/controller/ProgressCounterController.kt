...
internal class ProgressCounterController(
    ...
    private fun Int.isWithBounds(): Boolean = this > -1 && this <= model.maximum
    ...
    override fun maximumFormatted(): CharSequence = "/ ${model.maximum}"

    override fun currentFormatted(): CharSequence = "${model.current}"
}
