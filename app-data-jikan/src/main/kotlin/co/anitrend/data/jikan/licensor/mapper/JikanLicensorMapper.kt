...
package co.anitrend.data.jikan.licensor.mapper
...
internal sealed class JikanLicensorMapper : DefaultMapper<JikanMediaModel, JikanLicensorEntity>() {

    class Embed(
        override val localSource: JikanLicensorLocalSource,
        override val converter: JikanLicensorModelConverter
    ) : EmbedMapper<JikanItem, JikanLicensorEntity>()
}