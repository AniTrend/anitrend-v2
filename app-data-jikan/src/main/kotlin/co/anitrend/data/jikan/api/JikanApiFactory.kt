...
package co.anitrend.data.jikan.api
...
import co.anitrend.data.jikan.BuildConfig
...
internal class JikanApiFactory : IEndpointFactory {
    override val endpointType = object : IEndpointType {
        override val url: HttpUrl = BuildConfig.jikanMoe.toHttpUrl()
    }
